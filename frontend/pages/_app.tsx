...
function MyApp({ Component, pageProps }: AppProps) {
  ...
  const noHeaderFooterPaths = ['/admin', '/admin/login', '/admin/signup','/admin/dashboard','/admin/orders','/admin/banners','/admin/product-management','/admin/categories','/admin/edit-profile', '/auth/forgot-password', '/auth/reset-password'];
